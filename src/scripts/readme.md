# Bush V2 & V3 Deployment Documentation Scripts

These scripts make it easy to generate deployment diagrams for Bush contracts, showing all versions of a particular product (e.g., weighted pool), over time. The output is in the form of SVG files, which can be copied to the public docs or used in illustrations.
...
`python3 src/scripts/make_graph.py docs/deployments.json docs/output/routers.dot v3-router,v3-batch-router,v3-composite-liquidity-router,v3-buffer-router`
